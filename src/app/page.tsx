  ...
  return (
    ...
    >
      ...
      <main className="flex flex-col items-center justify-center flex-1 w-full px-4 pt-10 pb-16">
        ...
        <section className="flex flex-row gap-20 md:gap-32 items-end justify-center w-full max-w-5xl h-full mt-0">
          {/* Wil Card */}
          <div className="flex flex-col justify-between w-80 h-full">
            ...
            <div className="flex flex-col flex-1 items-center w-full">
              ...
              <div className="mt-4 max-w-[340px] w-full"><div className="px-5 py-4 rounded-xl shadow text-gray-800 text-lg font-semibold text-center bg-gradient-to-r from-[#b0b4ba] via-[#e0e3ea] to-[#a0a4ac] border border-gray-400 w-full">Start a chat</div></div>
            </div>
          </div>
          {/* Ellie Card */}
          <div className="flex flex-col justify-between w-80 h-full">
            ...
            <div className="flex flex-col flex-1 items-center w-full">
              ...
              <div className="mt-4 max-w-[340px] w-full"><div className="px-5 py-4 rounded-xl shadow text-gray-800 text-lg font-semibold text-center bg-gradient-to-r from-[#b0b4ba] via-[#e0e3ea] to-[#a0a4ac] border border-gray-400 w-full">Let’s Talk About You</div></div>
            </div>
          </div>
        </section>
      </main>
